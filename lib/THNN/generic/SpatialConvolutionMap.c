          ...
          accreal scale_)
{
  ...
  input = THTensor_(newContiguous)(input);
  gradOutput = THTensor_(newContiguous)(gradOutput);
  THArgCheck(THTensor_(isContiguous)(gradWeight), "gradWeight needs to be contiguous");
  THArgCheck(THTensor_(isContiguous)(gradBias), "gradBias needs to be contiguous");
