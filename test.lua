...
function nntest.Bottle()
   ...
   mytester:assertTensorEq(output1, output2, 0.0001, 'Bottle output not the same as Module')
   ...
   mytester:assertTensorEq(output1, output2, 0.0001, 'Bottle output not the same as Module')
   mytester:assertTensorEq(gradOutput1, gradOutput2, 0.0001, 'Bottle gradOutput not the same as Module')
end
