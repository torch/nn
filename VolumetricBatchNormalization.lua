--[[
   ...
   Usage:
   with    learnable parameters: nn.VolumetricBatchNormalization(N [,eps] [,momentum])
                                 where N = dimensionality of input
   without learnable parameters: nn.VolumetricBatchNormalization(N [,eps] [,momentum], false)
...
function BN:updateOutput(input)
   ...
   input.THNN.VolumetricBatchNormalization_updateOutput(
      input:cdata(),
      self.output:cdata(),
...
local function backward(self, input, gradOutput, scale, gradInput, gradWeight, gradBias)
   ...
   input.THNN.VolumetricBatchNormalization_backward(
      input:cdata(),
      gradOutput:cdata(),
